/**
 * @file region-utils.ts
 * @description 即梦区域配置工具类，统一管理不同区域（CN/US/HK/JP/SG等）的配置信息，包含ServiceId、ImageX URL、Origin、AWS Region等配置解析。
 */

import { RegionInfo } from "@/jimeng/controllers/core.ts";
import { BASE_URL_DREAMINA_US, BASE_URL_DREAMINA_HK, BASE_URL_IMAGEX_US, BASE_URL_IMAGEX_HK } from "@/jimeng/consts/dreamina.ts";
